...
// Ported verbatim from POE2Radar (MIT), Pathfinding/PathSmoother.cs. Namespace aside, the
// cost model, the heuristic, the snapping and the failure behaviour are the
// reference's — this is the algorithm, not an equivalent of it.
