...
/// <summary>
/// Ported from POE2Radar (MIT), <c>Overlay/IconLibrary.cs</c>: the built-in icon
/// table, the on-disk override convention and the SVG writer are the
/// reference's. The flattening to polygons at the bottom is ours, because our
/// canvas fills polygons where the reference builds Direct2D geometry.
/// </summary>
/// <remarks>
...
/// — the same convention <c>RadarSettings</c> uses for <c>config/</c>. Any <c>*.svg</c>
