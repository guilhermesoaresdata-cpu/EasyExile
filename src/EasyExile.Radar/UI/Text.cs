...
public static class Text
{
    ...
    public static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        // The rest of the panel: the levelling and campaign readouts, the
        // colour pickers and their legend, the price and potion rows, and the
        // whole diagnostics table. Found by asking which literals reach a
        // drawing call without a T() around them, rather than by reading.

        { " volta para o modo HUD", " returns to HUD mode" },
        { " de ", " of " },
        { " rotas", " routes" },
        { "BETA - em construcao", "BETA - work in progress" },
        { "Canto", "Corner" },
        { "Diario da campanha (BETA)", "Campaign journal (BETA)" },
        { "zonas anotadas nesta sessao: ", "zones recorded this session: " },
        { "areas conhecidas ", "areas known " },
        { "   visitadas ", "   visited " },
        { "   ligacoes ", "   links " },
        { "rota gravada     passo ", "recorded route   step " },
        { "desenhando:    ", "drawing:       " },
        { " - zona ", " - zone " },
        { "  (opcional)", "  (optional)" },
        ...
        { "ultimo: ", "last: " },
        { "Cor", "Colour" },
        { "Canto da marca", "Mark corner" },
        { "Cor da marca", "Mark colour" },
        { "Valor no slot", "Value in the slot" },
        { "Valor sob o cursor", "Value under the cursor" },
        { "acima do limite de destaque", "above the highlight threshold" },
        { "tem preco, acima do piso", "has a price, above the floor" },
        { "unique sem preco - pode valer qualquer coisa", "unique with no price - could be worth anything" },
        { "Nome de unique no chao", "Unique name on the ground" },
        { "Nome sem raridade conhecida", "Name with unknown rarity" },
        { "Muito valioso", "Very valuable" },
        { "Tem preco", "Has a price" },
        { "Unique sem preco", "Unique with no price" },
        { "liga", "league" },
        { "detectando", "detecting" },
        { "precos", "prices" },
        { " itens", " items" },
        { "ex por divine", "ex per divine" },
        { "AUTO POTION: ON", "AUTO POTION: ON" },
        { "AUTO POTION: OFF", "AUTO POTION: OFF" },
        { "Vida\0Escudo\0Qualquer um\0", "Life\0Energy Shield\0Either one\0" },
        { "frasco de vida", "life flask" },
        { "recarregando ", "recharging " },
        { "s", "s" },
        { "pronto", "ready" },
        { "frasco de mana", "mana flask" },
        { "disparos", "presses" },
        { " vida, ", " life, " },
        { " mana", " mana" },
        { "Cor do seu ponto", "Colour of your dot" },
        { "Cor dos minions", "Minion colour" },
        { "Chao ja percorrido", "Ground already walked" },
        { "Chao nao percorrido", "Ground not walked" },
        { "Cor do seu marcador no mundo", "Colour of your world marker" },
        { "No personagem\0HUD fixo\0", "On the character\0Fixed HUD\0" },
        { "prints salvos nesta sessao: ", "screenshots saved this session: " },
        { "render", "render" },
        { "captura", "capture" },
        { "idade do snapshot", "snapshot age" },
        { "projecao", "projection" },
        { "terrain", "terrain" },
        { "builds de textura", "texture builds" },
        { "escala", "scale" },
        { "centro", "centre" },
        { "entidades no mapa", "entities on the map" },
        { "ignoradas", "skipped" },
        { "inimigos", "enemies" },
        { "movimento", "movement" },
        { "pontos de interesse", "points of interest" },
        ...
        { "ameacas", "threats" },
        { "rotas", "routes" },
        { "saidas lembradas", "remembered exits" },
        { "trilha no mundo", "world trail" },
        { "barras de vida", "health bars" },
        { "drops precificados", "priced drops" },
        { "icones em cache", "cached icons" },
        { "map frame", "map frame" },
        { "falhas", "failures" },
        { "etiquetas do jogo", "game labels" },
        { "casadas com item", "matched to an item" },
        { "sem preco", "no price" },
        { "abaixo do minimo", "below the minimum" },
        { "categoria desligada", "category switched off" },
        { "desenhadas", "drawn" },
        { "entidades recebidas", "entities received" },
        { "fora da tela", "off screen" },
        { "atras da camera", "behind the camera" },
        { "projecao invalida", "invalid projection" },
        { "janela do jogo", "game window" },
        { "client area", "client area" },
        { "dpi", "dpi" },
        { "cache de rotulos", "label cache" },
        // The right-hand column of the diagnostics table, which was as
        // Portuguese as the labels and half as visible.
        ...
        { " raro, ", " rare, " },
        { " unico", " unique" },
        { " interpolados, ", " interpolated, " },
        { " diretos, ", " direct, " },
        { " rastreados", " tracked" },
        { " marcados, ", " marked, " },
        { " desenhados, ", " drawn, " },
        { " sem posicao", " with no position" },
        { " na area, ", " in the area, " },
        { " na tela", " on screen" },
        { " pontos", " points" },
        { " com ameaca", " threatening" },
        { " entradas, ", " entries, " },
        { " trocas de epoch", " epoch changes" },
        { "branco", "white" },
        ...
        { "roxo", "purple" },
        { "Minion (Mi)", "Minion (Mi)" },
        { "Projectile (Pj)", "Projectile (Pj)" },
        { "Spell (Sp)", "Spell (Sp)" },
        { "Attack (At)", "Attack (At)" },
        { "Fire (Fi)", "Fire (Fi)" },
        { "Cold (Co)", "Cold (Co)" },
        { "Lightning (Li)", "Lightning (Li)" },
        { "Chaos (Ch)", "Chaos (Ch)" },
        { "Life (HP)", "Life (HP)" },
        { "Energy Shield (ES)", "Energy Shield (ES)" },
        { "Spirit (Sr)", "Spirit (Sr)" },
        { "Crit (Cr)", "Crit (Cr)" },
        { "T1", "T1" },
        { "T2", "T2" },
        { "T3", "T3" },
        // The resistance mark, now that the player can drive it: who decides,
        // the target, the four elements, and the readout that says why it is
        // quiet.

        { "Marcar resistencias nos itens", "Mark resistances on items" },
        { "Quem escolhe", "Who decides" },
        { "O que falta para o alvo", "What is short of the target" },
        { "Eu escolho quais", "I pick which ones" },
        { "Marca so o que ainda nao chegou no alvo. Some quando tudo chegar.", "Marks only what has not reached the target. Goes away once everything has." },
        { "Marca sempre os elementos marcados, esteja capado ou nao.", "Always marks the ticked elements, capped or not." },
        { "Alvo", "Target" },
        { "Fogo (F)", "Fire (F)" },
        { "Frio (C)", "Cold (C)" },
        { "Raio (L)", "Lightning (L)" },
